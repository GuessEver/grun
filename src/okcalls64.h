...
unsigned OKCALL_PASCAL[256] = {0,1,2,3,4,9,11,13,16,59,89,97,201,231,SYS_open, SYS_set_thread_area, SYS_brk, SYS_read,
...
unsigned OKCALL_C[256] = {0, 1, 2, 4, 5, 9, 11, 12, 21, 59, 63, 89, 158, 231, 240, 8, SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
...
unsigned OKCALL_JAVA[256] = { 0,2,3,4,5,9,10,11,12,13,14,21,56,59,89,97,104,158,202,218,231,273,257,
...
unsigned OKCALL_PYTHON[256] = { 0,32,72,131,1,2,3,4,5,6,8,9,10,11,12,13,14,16,21,59,78,79,89,97,102,104,107,108,158,202,218,231,257,273
        , 41, 42, 146, SYS_mremap, 158, 117, 60, 39, 102, 191,
                     ...
                     SYS_write, 0 };
unsigned OKCALL_LUA[256]={0,1,2,3,4,5,9,10,11,12,13,21,59,158,231,292,0};

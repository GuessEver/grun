...
unsigned OKCALL_PASCAL[] = { 0,9, 59, 97, 13, 16, 89, 140, 91, 175, 195, 13, SYS_open, SYS_set_thread_area,
                           SYS_brk, SYS_read, SYS_uname, SYS_write, SYS_execve, SYS_ioctl,
                           SYS_readlink, SYS_mmap, SYS_rt_sigaction, SYS_getrlimit, 252, 191, 9999 };
unsigned OKCALL_C[] = {85, 8, 140, SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
                    SYS_close, SYS_execve, SYS_access, SYS_brk, SYS_munmap, SYS_mprotect,
                    SYS_mmap2, SYS_fstat64, SYS_set_thread_area, 252, 9999 };
unsigned OKCALL_JAVA[] = { 295, SYS_fcntl64, SYS_getdents64, SYS_ugetrlimit,
                     ...
                     SYS_exit_group, 9999 };
unsigned OKCALL_PYTHON[]={3,4,5,6,11,13,33,41,45,54,85,91,102,122,125,140,174,175,
                  183,186,191,192,195,196,197,199,200,201,202,220,221,
                  240,243,252,258,295,311,9999};
unsigned OKCALL_LUA[]={3,4,5,6,11,13,33,45,91,125,174,192,195,197,243,252,330,9999};
